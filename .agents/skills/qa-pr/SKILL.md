...
2. **Handoff** (User does this):
   - Clear instruction: "Press Cmd+O and open AGENTS.md"
   - Wait for user confirmation: "Let me know when done"

3. **Verify** (Codex does this):
...
**Do this now:**
1. Press **Cmd+O**
2. Select **AGENTS.md** from the project root
...
- Or ask user: "Reopen for me" (Codex relaunches)
...
**Workaround**: For keyboard shortcut testing, use collaborative manual testing where the user presses the keys and Codex verifies the results.
